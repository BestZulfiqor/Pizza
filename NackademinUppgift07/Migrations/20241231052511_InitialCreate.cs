    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MatrattTyp = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Beskrivning = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProduktID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProduktNamn = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BestallningID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BestallningDatum = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Totalbelopp = table.Column<decimal>(type: "DECIMAL(18,2)", nullable: false),
                    OrdinalBelopp = table.Column<int>(type: "INTEGER", nullable: false),
                    GratisPizzaPris = table.Column<int>(type: "INTEGER", nullable: false),
                    Rabatt = table.Column<decimal>(type: "DECIMAL(18,2)", nullable: false),
                    Levererad = table.Column<bool>(type: "INTEGER", nullable: false),
                    KundID = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MatrattID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    MatrattNamn = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Beskrivning = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MatrattID = table.Column<int>(type: "INTEGER", nullable: false),
                    BestallningID = table.Column<int>(type: "INTEGER", nullable: false),
                    Antal = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 1)
                },
                constraints: table =>
                {
